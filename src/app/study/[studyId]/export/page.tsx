              ...
              {pct < 100 && (
                <div className="bg-warning-100 text-warning-600 text-sm rounded-md px-4 py-3 mb-5">
                  {lang === 'ar'
                    ...
                    : `${100 - pct}% of mandatory cards are incomplete. Incomplete sections will be flagged.`}
                </div>
              )}
          ...
          {state === 'done' && url && (
            <>
              ...
              <p className={cn('text-sm text-slate-500 mb-6 text-center', lang === 'ar' && 'font-arabic')}>
                {lang === 'ar' ? 'دراستك جاهزة للتنزيل. الرابط صالح لمدة ساعة.' : 'Your study is ready. The link is valid for 1 hour.'}
              </p>
              <a
                href={url}
                target="_blank"
              ...
              <button onClick={handleExport} className="block w-full btn-ghost py-2.5 text-sm text-center">

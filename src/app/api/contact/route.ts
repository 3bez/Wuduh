...
export async function POST(request: NextRequest) {
  try {
    ...
    await resend.emails.send({
      ...
      html: `
        <div style="font-family: sans-serif; max-width: 560px; margin: 0 auto; padding: 40px 24px; color: #0D1B2A;">
          <h1 style="font-size: 22px; font-weight: 500; color: #0D1B2A; margin: 0 0 6px; letter-spacing: -0.02em;">
            New message via wuduh.site
          </h1>
          <p style="font-size: 13px; color: #8795A6; margin: 0 0 32px; font-family: monospace;">
    ...
    await resend.emails.send({
      ...
      html: `
        <div style="font-family: sans-serif; max-width: 560px; margin: 0 auto; padding: 40px 24px; color: #0D1B2A;">
          <h1 style="font-size: 22px; font-weight: 500; color: #0D1B2A; margin: 0 0 12px; letter-spacing: -0.02em;">
